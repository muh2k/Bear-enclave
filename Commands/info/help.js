...
module.exports = {
    ...
    run: async (client, message, args, prefix) => {
        ...
        if (!message.member.permissions.has(Permissions.FLAGS.MANAGE_MESSAGES)) return message.channel.send(`**The only command you have access to is memberinfo its use is [${prefix}memberinfo | user] **`);
